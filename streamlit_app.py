...
if option == "summerize":
    ...
    if inpu:
        ...
        if response :
            ...
            re_fa = GoogleTranslator(source="en" , target="de").translate(re)
            st.success(re)
            st.warning(re_fa)
        else :
...
if option == "generate article":
    ...
    fa_or_en = st.selectbox("Choose The Language You Want : " , ("Germany" , "english"))
    ...
    if fa_or_en:
        ...
        for title_input in lisst :
            ...
            headers_fa = GoogleTranslator(source="en" , target="de").translate_batch(headers)
            li = []
            for i in headers :
            ...
            for items in list_en :
                fa_append = GoogleTranslator(source="en" , target="de").translate(items)
            ...
            questions_fa = GoogleTranslator(source="en" , target="de").translate_batch(questions)
            answer = []
        ...
        for title_input in lisst:
            ...
            if fa_or_en == "Germany" :
                if not os.path.exists(title_input):
                    title_input = GoogleTranslator(source="auto" , target="de").translate(title_input)
...
if option == "title generator":
    ...
    if topic_input:
        ...
        if generate_content == "no" :
            ...
            res_to_farsi = GoogleTranslator(source="auto" , target="de").translate(res)
        ...
        if generate_content == "yes":
            ...
            fa_or_en = st.selectbox("Choose The Language You Want : " , ( "choose" , "Germany" , "english"))
            if fa_or_en == "choose":
